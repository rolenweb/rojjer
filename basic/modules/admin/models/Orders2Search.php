...
use app\modules\admin\models\Orders2;

/**
 * Orders2Search represents the model behind the search form about `app\modules\admin\models\Orders2`.
 */
class Orders2Search extends Orders2
{
    /**
     * @inheritdoc
     */
    ...
    {
        $query = Orders2::find()->orderBy(['updated_at' => SORT_DESC]);
