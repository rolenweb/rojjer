...
/**
 * Orders4Search represents the model behind the search form about `app\modules\admin\models\Orders4`.
 */
class Orders4Search extends Orders4
{
    /**
     * @inheritdoc
     */
    public function rules()
    {
        return [
            ...
            [['username', 'srok', 'othercategory', 'title', 'text', 'texthiden', 'filename', 'textready', 'filenameready', 'commentclient', 'commenttranslate'], 'safe'],
    ...
    {
        $query = Orders4::find()->orderBy(['updated_at' => SORT_DESC]);
