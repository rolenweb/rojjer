                ...
                <ul class="nav navbar-right">
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu dropdown-scroll dropdown-messages">
                            ...
                            <li class="dropdown-header">
                                <i class="fa fa-money"></i> Balance: <i class="fa fa-usd"></i>
                            </li>
                    ...
                    <li class="dropdown">
                        <a href="#" class="alerts-link dropdown-toggle" data-toggle="dropdown">
                            ...
                            <span class="number"></span><i class="fa fa-caret-down"></i>
                        </a>
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu dropdown-user">
                            <li>
                                ...
                                <?= Html::a(Html::tag('i','',['class' => 'fa fa-user']).' My Profile', ['/exchange/default/profile', 'id' => Yii::$app->user->identity->id]) ?>
                            </li>
                            <li>
                                <a href="mailbox.html">
