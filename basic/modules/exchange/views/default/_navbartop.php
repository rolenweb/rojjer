...
<nav class="navbar-top" role="navigation">
            ...
            <div class="navbar-header">
                ...
                <div class="navbar-brand">
                    ...
                    <?= Html::a(Html::img('@web/exchange/img/logo.png', ['class' => 'img-responsive', 'alt' => 'RoJJoR']), ['index']) ?>
                </div>
            </div>
            <!-- end BRAND HEADING -->
                ...
                <ul class="nav navbar-right">
                    ...
                    <li class="dropdown">
                        <a href="#" class="messages-link dropdown-toggle" data-toggle="dropdown">
                             ...
                             <i class="fa fa-usd"></i> <?= Html::encode($modelbalanceuser->balance) ?>
                        </a>
                        <ul class="dropdown-menu dropdown-scroll dropdown-messages">

                            <!-- Messages Dropdown Heading -->
                            <li class="dropdown-header">
                                <i class="fa fa-money"></i> Balance: <i class="fa fa-usd"></i><?= Html::encode($modelbalanceuser->balance) ?>
                            </li>
                                        ...
                                        <a>
                                            <div class="row">
                                                ...
                                                <div class="col-xs-10 text-center">
                                                    <i class="fa fa-usd"></i><?= Html::encode($modelbalanceuser->hold) ?>
                                                </div>
                                            </div>
                                        </a>
                                    </li>
                                        ...
                                        <a>
                                            <div class="row">
                                                ...
                                                <div class="col-xs-10 text-center">
                                                    ...
                                                    $total = $modelbalanceuser->balance + $modelbalanceuser->hold;

                                                    ?>
                                                    <i class="fa fa-usd"></i><?= Html::encode($total) ?>
                                                </div>
                                            </div>
                                        </a>
                                    </li>
                            ...
                            <li class="dropdown-footer">
                                ...
                                <?= Html::a('View balance', ['balance', 'id' => Yii::$app->user->identity->id]) ?>
                            </li>

                        </ul>
                    </li>
                    <li class="dropdown">
                        <a href="#" class="balance-link dropdown-toggle" data-toggle="dropdown">
                                ...
                                <ul class="list-unstyled">
                                        ...
                                        <a href="#">
                                            <div class="row">
                                                <div class="col-xs-2">
                                                    ...
                                                    <?= Html::img('@web/exchange/img/user-profile-1.jpg', ['class' => 'img-circle', 'alt' => 'Avatar']) ?>
                                                </div>
                                                <div class="col-xs-10">
                                                    <p>
                                    ...
                                    <li>
                                        <a href="#">
                                            <div class="row">
                                                <div class="col-xs-2">
                                                    <?= Html::img('@web/exchange/img/user-profile-2.jpg', ['class' => 'img-circle', 'alt' => 'Avatar']) ?>
                                                </div>
                                                <div class="col-xs-10">
                                                    <p>
                                    ...
                                    <li>
                                        <a href="#">
                                            <div class="row">
                                                <div class="col-xs-2">
                                                    <?= Html::img('@web/exchange/img/user-profile-3.jpg', ['class' => 'img-circle', 'alt' => 'Avatar']) ?>
                                                </div>
                                                <div class="col-xs-10">
                                                    <p>
                                    ...
                                    <li>
                                        <a href="#">
                                            <div class="row">
                                                <div class="col-xs-2">
                                                    <?= Html::img('@web/exchange/img/user-profile-4.jpg', ['class' => 'img-circle', 'alt' => 'Avatar']) ?>
                                                </div>
                                                <div class="col-xs-10">
                                                    <p>
                    ...
                    <li class="dropdown">
                        <a href="#" class="alerts-link dropdown-toggle" data-toggle="dropdown">
                            ...
                            <span class="number"><?= Html::encode($countalertsorder+$countalertsbalance) ?></span><i class="fa fa-caret-down"></i>
                        </a>
                        <ul class="dropdown-menu dropdown-scroll dropdown-alerts">

                            <!-- Alerts Dropdown Heading -->
                            <li class="dropdown-header">
                                <i class="fa fa-bell"></i> <?= Html::encode($countalertsorder+$countalertsbalance) ?> New Alerts
                            </li>
                            ...
                            <li id="alertScroll">
                                <ul class="list-unstyled">
                                    <li>
                                        ...
                                        <?= Html::a(
                                            Html::tag('div',
                                                Html::tag('i','',['class' => 'fa fa-pencil-square-o'])
                                                ,['class' => 'alert-icon green pull-left']).'Order'.
                                                Html::tag('span',Html::encode($countalertsorder),['class' => 'badge green pull-right'])
                                            ,
                                            ['alerts', 'id' =>Yii::$app->user->identity->id, 'type' => 0]
                                        ) ?>
                                    ...
                                    <li>
                                        ...
                                        <?= Html::a(
                                            Html::tag('div',
                                                Html::tag('i','',['class' => 'fa fa-money'])
                                                ,['class' => 'alert-icon green pull-left']).'Balance'.
                                                Html::tag('span',Html::encode($countalertsbalance),['class' => 'badge green pull-right'])
                                            ,
                                            ['alerts', 'id' =>Yii::$app->user->identity->id, 'type' => 1]
                                        ) ?>
                                    </li>
                                    <li>
                                        <a href="#">
                            ...
                            <li class="dropdown-footer">
                                ...
                                <?= Html::a('View All Alerts', ['alerts', 'id' => Yii::$app->user->identity->id])?>
                            </li>
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu dropdown-user">
                            <li>
                                ...
                                <?= Html::a(Html::tag('i','',['class' => 'fa fa-user']).' My Profile', ['profile', 'id' => Yii::$app->user->identity->id]) ?>
                            </li>
                            <li>
                                <a href="mailbox.html">
                            ...
                            <li>
                                ...
                                <?= Html::a(
                                    Html::tag('i','', ['class' => 'fa fa-bell']).
                                    ' My Alerts'.
                                    Html::tag('span',Html::encode($countalertsorder),['class' => 'badge orange pull-right'])
